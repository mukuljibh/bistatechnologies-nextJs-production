...
import styles from '../../../../styles/it-staffing.module.css'
...
export default function ItSubCards() {
    ...
    return (
        <div className="bg-purple-50 py-20 space-y-10">
            ...
            <div className={`itStaffing px-5  lg:flex  justify-center ${isCardVisible && styles.itSubCard} gap-16 lg:space-y-0 space-y-10`}>
