...
export default function ItSubCards() {
    const { isCardVisible } = useObserver('itStaffing', 0.7, ['opacity-100'])
    return (
        <div className="bg-purple-50 py-20 space-y-10">
            ...
            <div className={`itStaffing  lg:flex  justify-center ${isCardVisible && 'itSubCard'} gap-16 lg:space-y-0 space-y-10`}>
