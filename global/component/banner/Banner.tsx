...
export default function Banner({ heading, subHeading, image }: bannerProps) {
    ...
    return (
        <div className="space-y-10">
            <div className="relative w-full bg-sky-200 overflow-hidden lg:flex lg:space-y-0 pt-10 ">
                ...
                <div className="bannerImg z-10 lg:w-1/3   mx-auto opacity-0 " >
                    <Image
                        className=" mx-auto lg:w-auto w-1/2 lg:h-64 object-cover "
                        src={image?.imageSrc}
                        alt={image?.alt}
                        width={500}
                        height={250}
